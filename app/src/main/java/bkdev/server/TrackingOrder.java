...
import bkdev.server.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if (mLastLocation != null)
            {
                ...
                mMap.addMarker(new MarkerOptions().position(yourLocation).title("คำแหน่งของคุณ"));
            ...
            {
                Toast.makeText(this, "ไม่สามารถรับตำแหน่งได้", Toast.LENGTH_SHORT).show();
            }
        }
    }
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try{
                    ...
                    MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("รายการของ "+Common.currentRequest.getPhone())
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS)
        {
            ...
            {
                Toast.makeText(this, "อุปกรณ์นี้ไม่รองรับ", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }

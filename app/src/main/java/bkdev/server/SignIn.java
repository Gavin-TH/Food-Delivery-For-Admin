            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(localPhone).exists())
                {
                    ...
                    if (Boolean.parseBoolean(user.getIsStaff()))
                    {
                        ...
                        Toast.makeText(SignIn.this, "กรุณาเข้าสู่ระบบด้วยบัญชีผู้ดูแล", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    mDialog.dismiss();
                    Toast.makeText(SignIn.this, "ชื่อผู้ใช้งานไม่มีอยู่ในฐานข้อมูล", Toast.LENGTH_SHORT).show();
                }
